...
class Recon(framework.Framework):
    ...
    def _create_db(self):
        ...
        self.query('CREATE TABLE IF NOT EXISTS hosts (host TEXT, ip_address TEXT, asn TEXT, org TEXT, region TEXT, country TEXT, latitude TEXT, longitude TEXT, module TEXT)')
